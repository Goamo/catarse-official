...
// Теперь у setBrushType есть флаг closeDropdown — по умолчанию false:
export function setBrushType(type, closeDropdown = false) {
    ...
    // Закрываем дропдаун только если closeDropdown === true
    if (closeDropdown) {
        toggleBrushDropdown();
    }
}
